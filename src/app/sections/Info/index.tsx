    ...
    return <div className={styles.backgroud}>
        ...
        <div className={styles.column}>
            <div className={styles.card}>
                ...
                <div className={styles.socialWrapper}><a href='https://github.com/rakesh-m-r'><Icon iconName={"ri-github-fill"}/></a>
                    <a href='https://www.linkedin.com/in/rakesh-m-r'><Icon iconName={"ri-linkedin-fill"}/></a>
                    <a href='https://twitter.com/rakesh_m_r_'><Icon iconName={"ri-twitter-x-fill"}/></a>
                </div>
            </div>
        </div>
    </div>
