...
const InfoSection:React.FC<{}> = ():ReactElement =>{
    return <><div id='about' className={styles.backgroud}>
        ...
        <div className={styles.column}>
            <div className={styles.card}>
                ...
                <div className={styles.socialWrapper}>
                    <a className={styles.link} target='_blank' href='https://github.com/rakesh-m-r'><Icon iconName={"ri-github-fill"}/></a>
                    <a className={styles.link} target='_blank' href='https://www.linkedin.com/in/rakesh-m-r'><Icon iconName={"ri-linkedin-fill"}/></a>
                    <a className={styles.link} target='_blank' href='https://twitter.com/rakesh_m_r_'><Icon iconName={"ri-twitter-x-fill"}/></a>
                </div>
            </div>
        </div>
    </div>
    <div className={styles.btnWrapper}><a className={styles.btn} href={"#experience"}><Icon iconName="ri-mouse-line"/></a></div>
