...
const EXPERIENCE = [
  {
    ...
    designation:
      "Software Engineer Intern --> Software Engineer I --> Software Engineer II ",
    description:
  ...
  },
  {
    ...
    designation: "Software Engineer II - IHN",
    description:
  ...
  },
  {
    ...
    designation: "Software Engineer II- SurveyMonkey",
    description:
...
const Experience: React.FC<{}> = (): ReactElement => {
  return (
    <>
      <h1 className={styles.workHeading}>Experience</h1>
      <div id="experience" className={styles.backgroud}>
        {EXPERIENCE.map((item, index) => {
          return (
            <a href={item.weblink} key={index}>
