...
function menubar() {
  if (document.querySelector('.menubar').textContent == 'menu') {
    ...
    document.querySelector('#ani0').style = "animation: heartBeat;animation-duration: 2s;";
    document.querySelector('#ani1').style = "animation: heartBeat;animation-duration: 2s;";
    document.querySelector('#ani2').style = "animation: heartBeat;animation-duration: 2s;";
    document.querySelector('#ani3').style = "animation: heartBeat;animation-duration: 2s;";
